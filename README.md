...
1. Marine datasets covering the Mediterranean Sea and the global ocean from ESA-funded science projects, hosted on object storage.
2. A Mediterranean Sea datacube with a common spatial grid and separate stores for monthly, hourly, and daily data.
...
4. Information about creating a local environment to work in, or using the provided cloud platform.
...
| `1_Datasets/` | Dataset catalogue and information per source product. | `1_Datasets/datasets_sumary.ipynb` |
| `2_Datacube/` | ESA Mediterranean Sea Datacube and access examples.| `2_Datacube/0_intro.ipynb` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 4DMED-SEA sea-surface salinity | Mediterranean salinity and density fields | Zarr | EPSG:4326, 1/24° lat/lon grid | Daily, 2016–2022 | CC-BY-4.0 | [OSC](https://opensciencedata.esa.int/products/4dmed-2d-sss/collection) | [Notebook](1_Datasets/4dmed-ss/access.ipynb) |
| 4DMED-SEA MIOST Lagrangian eddies | Mediterranean current structures and eddies | Zarr | EPSG:4326, 1/24° lat/lon grid | Daily, April 2016–July 2022 | CC-BY-4.0 | [OSC](https://opensciencedata.esa.int/products/4dmed-2d-alt-miost-le-24/collection) | [Notebook](1_Datasets/4dmed-fsle/access.ipynb) |
| 4DMED-SEA 4DVarNet 1/8° | Sea-level and geostrophic velocity fields | Zarr | EPSG:4326, 1/8° lat/lon grid | Daily, January 2016–August 2022 | CC-BY-4.0 | [OSC](https://opensciencedata.esa.int/products/4dmed-2d-alt-varnet-8/collection) | [Notebook](1_Datasets/4dmed-4dvar-8/acces.ipynb) |
| 4DMED-SEA 4DVarNet 1/20° | Sea-surface height and derived variables | Zarr | EPSG:4326, 1/20° lat/lon grid | Daily, January 2016–August 2022 | CC-BY-4.0 | [OSC](https://opensciencedata.esa.int/products/4dmed-2d-alt-varnet-20/collection) | [Notebook](1_Datasets/4dmed-4dvar-20/acces.ipynb) |
| 4DMED-SEA PFT and Kd | Phytoplankton functional types and diffuse attenuation | Zarr | EPSG:4326, 8 km lat/lon grid | Monthly, 2019–2021 | CC-BY-4.0 | [OSC](https://opensciencedata.esa.int/products/4dmed-2d-pft-kd/collection) | [Notebook](1_Datasets/4dmed-2d-pft-kd/access.ipynb) |
| 4DMED-SEA 3D physical fields | Temperature, salinity, density, and geostrophic velocity | Zarr | EPSG:4326, 1/24° grid with 20 depth levels to 153 m | Daily, January 2016–July 2022 | CC-BY-4.0 | [OSC](https://opensciencedata.esa.int/products/4dmed-t-s-geo-150/collection) | [Notebook](1_Datasets/4dmed-t-s-geo-150/access.ipynb) |
| 4DMED-SEA primary production | Primary production from chlorophyll and temperature | Zarr | EPSG:4326, 1/24° grid with 148 depth levels to 150 m | Daily, January 2016–August 2022 | CC-BY-4.0 | [OSC](https://opensciencedata.esa.int/products/4dmed-3d-prim-prod-150/collection) | [Notebook](1_Datasets/4dmed-pp/access.ipynb) |
| 4DMED-SEA 3D biophysical fields | Chlorophyll-a plus physical and velocity variables | Zarr | EPSG:4326, 1/24° grid with 148 depth levels to 150 m | Daily, January 2016–August 2022 | CC-BY-4.0 | [OSC](https://opensciencedata.esa.int/products/4dmed-t-s-geo-a-150/collection) | [Notebook](1_Datasets/4dmed-t-s-a-geo-150/access.ipynb) |
...
The [ESA Mediterranean Sea Datacube](2_Datacube/0_intro.ipynb) combines marine datasets on a common 1/24° EPSG:4326 grid. The data are available in four online GeoZarr stores with different time and depth coordinates:

| Store | Contents | Cube coordinate coverage |
| --- | --- | --- |
| [ocean-med-monthly-cube.zarr](https://s3.waw4-1.cloudferro.com/EarthCODE/OSCAssets/med_cubes/ocean-med-monthly-cube.zarr) | 4DMED PFT/Kd, ocean heat content, OceanSODA, BICEP, and MITHO | Monthly, January 2016–December 2022 |
| [hourly_cube.zarr](https://s3.waw4-1.cloudferro.com/EarthCODE/OSCAssets/med_cubes/hourly_cube.zarr) | WOC and CMEMS current components at 15 m | Hourly, 30 December 2014–30 December 2019 |
| [ocean-med-biophysics.zarr](https://s3.waw4-1.cloudferro.com/EarthCODE/OSCAssets/med_cubes/ocean-med-biophysics.zarr) | 4DMED primary production and 3D physical fields at 18 depths, 3–135 m | Daily, 1 January 2016–31 July 2022 |
| [ocean-med-daily-surface-cube.zarr](https://s3.waw4-1.cloudferro.com/EarthCODE/OSCAssets/med_cubes/ocean-med-daily-surface-cube.zarr) | 4DMED salinity/density, FSLE, both 4DVarNet reconstructions, and CAREHeat categories | Daily, 1 January 2016–31 December 2022 |

The notebooks open these online stores directly over HTTPS using consolidated metadata. An internet connection is required; only the selected chunks are read. Group `0` is full resolution; groups `1` and `2` contain spatial summaries at 1/6° and 1/3°. Individual products may cover only part of a store's time axis.

Start with [cube access and example plots](2_Datacube/1_remote_cube_access.ipynb), then explore [building a small local cube](2_Datacube/2_build_single_cube_demo.ipynb) and [time series at every depth](2_Datacube/3_large_area_processing.ipynb). The [overview](2_Datacube/0_intro.ipynb) lists source products, OSC links, variables, licences, and how the data were combined.
